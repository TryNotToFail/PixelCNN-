...
def train_or_test(model, data_loader, optimizer, loss_op, device, args, epoch, mode = 'training'):
    ...
    for batch_idx, item in enumerate(tqdm(data_loader)):
        model_input, _, class_labels = item
...
if __name__ == '__main__':
    ...
    if args.en_wandb:
        ...
        wandb.init(
            ...
            entity="ducthanghuynh123-university-of-british-columbia",
    ...
    # added the num_classes and embedding_dim
    ...
    for epoch in tqdm(range(args.max_epochs)):
        ...
        if epoch % args.sampling_interval == 0:
            ...
            predicted_classes = get_label(model, sample_t.to(device), device)
            print("Predicted classes for generated samples:", predicted_classes.cpu().numpy())
            print("Conditioned labels for generated samples:  ", img_labels.cpu().numpy())
